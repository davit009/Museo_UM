  ...
  Future<void> _loadPreferences() async {
    ...
    try {
      final response = await _client
          .from('profiles')
          .select('mentoria_abierta, profile_theme, biografia, estado_actual, puesto_actual, empresa_actual, es_egresado')
          .eq('id', user.id)
          .single();
          ...
          : ListView(
              children: [
                ...
                Container(
                  color: Colors.white,
                  child: ListTile(
                    leading: const Icon(Icons.person_outline, color: Color(0xFF1A2B4A)),
                    title: const Text('Editar Información del Perfil', style: TextStyle(fontWeight: FontWeight.w600)),
                    subtitle: const Text('Actualiza tu biografía, estado y rol'),
                ...
                if (_esEgresado) ...[
                  ...
                  Container(
                    ...
                    child: SwitchListTile(
                      ...
                      subtitle: const Text('Permite que estudiantes te contacten'),
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ListTile(
                        leading: const Icon(Icons.lock_outline, color: Color(0xFF1A2B4A)),
                        title: const Text('Privacidad de la Cuenta', style: TextStyle(fontWeight: FontWeight.w600)),
                        trailing: const Icon(Icons.chevron_right),
                        onTap: () {},
                      ),
                      ListTile(
                        leading: const Icon(Icons.notifications_outlined, color: Color(0xFF1A2B4A)),
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ListTile(
                        leading: const Icon(Icons.privacy_tip_outlined, color: Color(0xFF1A2B4A)),
                      ...
                      ListTile(
                        leading: const Icon(Icons.description_outlined, color: Color(0xFF1A2B4A)),
                      ...
                      ListTile(
                        leading: const Icon(Icons.support_agent, color: Color(0xFF1A2B4A)),
                  ...
                  child: Column(
                    children: [
                      ListTile(
                        ...
                        title: const Text('Cerrar Sesión', style: TextStyle(fontWeight: FontWeight.w600, color: Colors.orange)),
                        onTap: _signOut,
                      ),
                      ListTile(
